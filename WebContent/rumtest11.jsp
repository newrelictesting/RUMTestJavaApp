...
<head>
<title>RUM Test Page 11</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<%= com.newrelic.api.agent.NewRelic.getBrowserTimingHeader() %>
</head>
<body>
	<h1>Welcome to RUM Test Page 11</h1>
	<h2>Use Alert on this page</h2>
	Light Rum, also referred to as silver rum and white rum. In general, light rum has very little flavor aside from a general sweetness, and serves accordingly as a base for cocktails.<p>
