...
<title>RUM Test Page 6</title>
</head>
<body>
	<h1>Welcome to RUM Test Page 6</h1>
	<h2> Overproof Rum - 超标甜酒</h2>
	Overproof Rum is rum that is much higher than the standard 40% alcohol. Don't get drunk with it;) <p>
